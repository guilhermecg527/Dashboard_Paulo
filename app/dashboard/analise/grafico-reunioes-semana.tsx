...
export default function GraficoReunioesSemana({ dias }: { dias: number }) {
  // "dias" poderá ser utilizado futuramente para filtrar dados reais
  ...
  return (
    <div className="p-6 rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-100 shadow-sm">
      <h3 className="text-lg font-semibold mb-2">4. Reuniões por Dia da Semana</h3>
